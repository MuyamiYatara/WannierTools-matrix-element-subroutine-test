...
!===============================================================================================================!
   ...
   if (cpuid==0) then
      ...
      write(stdout, '(1x, a, i8   )')'If or not we are considering unpolarized light incoming', is_unpolarized_arpes
   endif
